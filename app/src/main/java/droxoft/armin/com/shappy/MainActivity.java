...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("tago" , "MainActivity onCreate");
    ...
    protected void onResume() {
        super.onResume();
        Log.i("tago" , "MainActivity onResume");
        //AppEventsLogger.activateApp(this);
        boolean a = sharedPrefMainDurumAl();
        if(!a){
            finish();
        }
        Log.i("tago" , "yuvaya dondu");
    }

    protected void onPause() {
        super.onPause();
        Log.i("tago", "MainActivity onPause");
        //AppEventsLogger.deactivateApp(this);
    }

    protected void onStop() {
        Log.i("tago" , "MainActivity onStop");
        super.onStop();
    }
    ...
    protected void onStart() {
        super.onStart();
        Log.i("tago", "MainActivity onStart");
        FacebookSdk.sdkInitialize(getApplicationContext());
    }
